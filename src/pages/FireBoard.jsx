...
export default function FireBoard() {
  ...
  if (loading) return <div className="flex justify-center items-center h-screen bg-slate-950"><div className="w-8 h-8 border-4 border-slate-700 border-t-red-500 rounded-full animate-spin" /></div>;
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-slate-950 gap-6">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400">Fire Operations Board</p>
        ...
        <div className="flex gap-3">
          ...
          <Button onClick={() => setClockInOpen(true)} className="bg-red-600 hover:bg-red-700 gap-2 px-8"><Clock className="w-4 h-4" /> Clock In</Button>
        </div>
