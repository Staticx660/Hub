...
export default function DepartmentsManager() {
  ...
  const openEdit = (d) => { setEditing(d); setForm({ name: d.name, category: d.category, description: d.description || "", color: d.color || "#3b82f6", discord_webhook_url: d.discord_webhook_url || "", discord_role_id: d.discord_role_id || "", discord_supervisor_role_id: d.discord_supervisor_role_id || "" }); setDialogOpen(true); };
          ...
          <div className="space-y-4">
            ...
            <div className="pt-3 border-t border-slate-700/50">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-slate-500">Guild ID is configured globally in the Discord tab. Only set the Role IDs below.</p>
