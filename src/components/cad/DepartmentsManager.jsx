...
const emptyForm = { name: "", category: "Police", description: "", color: "#3b82f6" };
...
export default function DepartmentsManager() {
  ...
  const openEdit = (d) => { setEditing(d); setForm({ name: d.name, category: d.category, description: d.description || "", color: d.color || "#3b82f6" }); setDialogOpen(true); };
